    ...
    function($, THREE, ShaderTerrain, OrbitControls, NormalMapShader, Detector, BufferGeometryUtils, anime) {
        ...
        function home() {
            this.init = function() {
                ...
                var diffuseTexture1 = textureLoader.load("static/img/grasslight-big.jpg");
                var diffuseTexture2 = textureLoader.load("static/img/white.jpg");
                var detailTexture = textureLoader.load( "static/img/grasslight-big-nm.jpg" );
            ...
            function render() {
                ...
                if (firstTime) {
                    ...
                    png.src = "./static/img/circle-colored-200.png"
                    firstTime = false;
                }
                if (terrain.visible) {
